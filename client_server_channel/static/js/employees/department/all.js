...
function deleteType(e) {
    ...
    if (result) {
        ...
        xhttp.open('DELETE', '/employees/department/delete/' + dept_id, true);
...
document.getElementById("addClick").onclick = function () {
    window.open('/employees/department/add', '_self');
};

// get_types dagi malumotlarni get_type ga olib boradi tr ni ikki marta click qilganda
function getType(e) {
    window.open('/employees/department/get/' + e.children[0].innerHTML, '_self');
}
